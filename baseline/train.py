...
def softmax_model_pretrain(train_list, train_dir, class_count, target_model_path):
    ...
    net.fit_generator(
        ...
        steps_per_epoch=len(images) / batch_size + 1, epochs=10,
    )
    net.save(target_model_path)


def softmax_pretrain_on_dataset(source):
    project_path = '/home/cwh/coding/Pig_reid'
    if source == 'market':
        train_list = project_path + '/dataset/market_train.list'
        train_dir = '/home/cwh/coding/Market-1501/train'
        class_count = 751
    elif source == 'pig':
        train_list = project_path + '/dataset/pig_train.list'
        train_dir = '/home/cwh/coding/Pig_reid/data/train/images'
        class_count = 30
    elif source == 'spig':
        train_list = project_path + '/dataset/pig_s_train.list'
        train_dir = '/home/cwh/coding/Pig_reid/data/train/s_images'
        class_count = 300
    elif source == 'grid':
